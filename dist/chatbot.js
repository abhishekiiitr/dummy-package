// HTML code
const $108de96807862aa0$var$chatboxHTML = `
<!DOCTYPE html>
<html>
...
`;
// CSS code 
const $108de96807862aa0$var$chatboxCSS = `
#chatbox {
    position: fixed;
    bottom: 10px;
    right: 10px;
...
document.body.innerHTML += $108de96807862aa0$var$chatboxHTML;
// Added the CSS to the DOM
const $108de96807862aa0$var$style = document.createElement("style");
$108de96807862aa0$var$style.innerHTML = $108de96807862aa0$var$chatboxCSS;
document.head.appendChild($108de96807862aa0$var$style);
...
document.getElementById("send-button").addEventListener("click", function() {
    ...
    input.value = "";
    $108de96807862aa0$var$addMessage(text, "Human");
    $108de96807862aa0$var$addMessage("Response will go here", "Chatbot");
